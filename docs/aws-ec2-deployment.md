...
Runtime: Ubuntu ARM64 on EC2 t4g.small, Docker Compose, Caddy, and the Go API on the internal `api:8080` network. Public traffic is only HTTPS at `https://deinscomplete.web.id`.
